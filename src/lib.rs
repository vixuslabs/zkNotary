...
pub fn main() {
    ...
    let notary_pubkey_str = r#"-----BEGIN PUBLIC KEY-----
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEBv36FI4ZFszJa0DQFJ3wWCXvVLFr
cRzMG5kaTeHGoSzDu6cFqx3uEWYpFGo6C0EOUgf+mEgbktLrXocv5yHzKg==
-----END PUBLIC KEY-----
"#;

    match notary_pubkey_from_str(notary_pubkey_str) {
        Ok(public_key) => {
            session
...
const PROOF_JSON: &str = r#"
{
    "session": {
        ...
        "signature": {
            "P256": "82E32D7F622C5CD1119667FAA1103C7D7763862787052B55D46EDC1E2C2BAD1A0F729E34C1D9AEFA146FB5073EA7BC0C43E410C46B584582B536E8F65C109CE3"
        },
